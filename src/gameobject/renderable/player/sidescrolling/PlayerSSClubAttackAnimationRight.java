...
public class PlayerSSClubAttackAnimationRight extends Animation {

    public PlayerSSClubAttackAnimationRight(String imageDirectory) {
        String path = "/assets/player/color/" + imageDirectory + "/sidescroll/attack/club/right/";
