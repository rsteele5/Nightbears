...
public class PlayerSSRunningAnimationLeft extends Animation {

    public PlayerSSRunningAnimationLeft(String imageDirectory) {
        String path = "/assets/player/color/" + imageDirectory + "/sidescroll/running/left/";
