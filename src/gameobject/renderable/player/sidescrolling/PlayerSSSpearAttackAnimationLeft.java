...
public class PlayerSSSpearAttackAnimationLeft extends Animation {

    public PlayerSSSpearAttackAnimationLeft(String imageDirectory) {
        String path = "/assets/player/color/" + imageDirectory + "/sidescroll/attack/spear/left/";
