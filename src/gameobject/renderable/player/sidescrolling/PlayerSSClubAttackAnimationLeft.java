...
public class PlayerSSClubAttackAnimationLeft extends Animation {

    public PlayerSSClubAttackAnimationLeft(String imageDirectory) {
        String path = "/assets/player/color/" + imageDirectory + "/sidescroll/attack/club/left/";
